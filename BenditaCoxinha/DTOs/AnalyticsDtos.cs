// =============================================================================
// AnalyticsDtos.cs â€” DTOs para o mÃ³dulo de analytics do dashboard admin
// =============================================================================
...
public class DashboardAnalyticsDto
{
    ...
    // Top produtos vendidos (Ãºltimos 30 dias)
    public List<TopProductDto> TopProdutos { get; set; } = new();

    // Forma de pagamento (Ãºltimas vendas avulsas com pagamento registrado)
...
public class ClienteInsightDto
{
    ...
    public bool    Inativo30    { get; set; }  // sem visita nos Ãºltimos 30 dias
    public int     Pontos       { get; set; }
    /// <summary>Dias atÃ© os pontos vencerem. Negativo = jÃ¡ venceu. Null = sem data de vencimento.</summary>
...
public class FinanceiroDto
{
    ...
    public decimal ReceitaComandas  { get; set; } // sÃ³ comandas fechadas
    public decimal ReceitaAvulsa    { get; set; } // sÃ³ vendas avulsas
    ...
    public decimal Crediarios        { get; set; } // total em aberto nos crediÃ¡rios (R$)
    public decimal RecebidoCrediario { get; set; } // total recebido de crediÃ¡rios no perÃ­odo
...
public class FormaPagamentoTotalDto
{
    ...
    /// <summary>TransaÃ§Ãµes individuais que compÃµem esse total (drill-down).</summary>
...
public class TransacaoFinDto
{
    ...
    /// <summary>Usado internamente no agrupamento â€” nÃ£o serializado.</summary>
