...
public class VendaAvulsaRequest
{
    ...
    [Required]
    public string PaymentMethod { get; set; } = Models.PaymentMethod.Pix;
    ...
    public bool IsPaymentMethodValid() =>
        Models.PaymentMethod.IsValid(PaymentMethod) &&
        (SecondPaymentMethod == null || Models.PaymentMethod.IsValid(SecondPaymentMethod));
}
