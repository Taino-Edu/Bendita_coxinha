...
/// Define um conjunto nomeado de permissÃµes que pode ser atribuÃ­do a usuÃ¡rios Operator.
/// </summary>
[Table("perfis")]
public class Perfil
{
    ...
    /// <summary>JSON array de chaves de permissÃ£o (ex: ["pdv","comandas","estoque"]).</summary>
    [Required]
...
/// <summary>Todas as permissÃµes disponÃ­veis no sistema.</summary>
public static class Permissao
{
    ...
    /// <summary>Mapeamento de permissÃ£o â†’ prefixos de rota da API que ela protege.</summary>
