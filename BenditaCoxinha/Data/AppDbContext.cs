// =============================================================================
// AppDbContext.cs â€” Contexto do Entity Framework Core (PostgreSQL)
// Configura mapeamentos, Ã­ndices, conversÃµes e seeds iniciais.
// =============================================================================

using BenditaCoxinha.Models.PostgreSQL;
using Microsoft.EntityFrameworkCore;

namespace BenditaCoxinha.Data;

/// <summary>
/// Contexto principal do EF Core para o banco PostgreSQL.
/// Gerencia todas as entidades relacionais da aplicaÃ§Ã£o.
/// </summary>
public class AppDbContext : DbContext
{
    ...
    // -------------------------------------------------------------------------
    // DbSets â€” Mapeamento das entidades para tabelas
    // -------------------------------------------------------------------------
    ...
    // â”€â”€ LGPD â€” Compliance e privacidade â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    public DbSet<LgpdRequest>   LgpdRequests   { get; set; }
    public DbSet<CookieConsent> CookieConsents { get; set; }

    // -------------------------------------------------------------------------
    // OnModelCreating â€” Fluent API para configuraÃ§Ãµes avanÃ§adas
    // -------------------------------------------------------------------------
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            // Busca por status (lista de requisiÃ§Ãµes abertas)
            ...
            // Relacionamento opcional com User (CPF pode nÃ£o existir no cadastro)
