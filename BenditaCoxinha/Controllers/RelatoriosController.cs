...
public class RelatoriosController : ControllerBase
{
        ...
        [FromQuery] int ano = 0)
    {
        ...
        // 2. Vendas Avulsas no mês (PostgreSQL)
        var vendasAvulsas = await _db.VendasAvulsas
            .AsNoTracking()
        ...
        foreach (var venda in vendasAvulsas)
        {
            ...
            {
                var cat = string.IsNullOrWhiteSpace(item.ProductCategory) ? "Outros" : item.ProductCategory;
