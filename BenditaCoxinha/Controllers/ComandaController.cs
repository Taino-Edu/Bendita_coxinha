// =============================================================================
// ComandaController.cs â€” Endpoints REST de Comandas
// GET    /api/comanda/dashboard           â†’ lista todas as abertas (Admin)
// GET    /api/comanda/my                  â†’ comanda ativa do cliente logado
// GET    /api/comanda/{id}                â†’ detalhe de uma comanda (Admin)
// POST   /api/comanda/{id}/items          â†’ adiciona item
// DELETE /api/comanda/{id}/items/{itemId} â†’ remove item
// PUT    /api/comanda/{id}/close          â†’ fecha comanda (Admin)
// PUT    /api/comanda/{id}/cancel         â†’ cancela comanda (Admin)
// POST   /api/comanda/{id}/apply-points   â†’ aplica pontos do cliente
//
// Venda avulsa de balcÃ£o â†’ POST /api/venda-avulsa  (VendaAvulsaController)
// =============================================================================
...
public class ComandaController : ControllerBase
{
    ...
    /// <summary>HistÃ³rico do dia: comandas fechadas/canceladas. ParÃ¢metro ?data=YYYY-MM-DD (padrÃ£o: hoje). Apenas Admin.</summary>
    [HttpGet("history")]
    [Authorize(Policy = "AdminOnly")]
    [ProducesResponseType(typeof(IEnumerable<ComandaDto>), 200)]
    ...
    /// <summary>Retorna uma comanda especÃ­fica pelo ID. Apenas Admin.</summary>
    [HttpGet("{id:guid}")]
    [Authorize(Policy = "AdminOnly")]
    [ProducesResponseType(typeof(ComandaDto), 200)]
    ...
    public async Task<IActionResult> GetById(Guid id)
    {
        ...
        return comanda == null ? NotFound(new { Message = "Comanda nÃ£o encontrada." }) : Ok(comanda);
    }

    /// <summary>HistÃ³rico de comandas fechadas/canceladas do cliente autenticado.</summary>
    [HttpGet("my-history")]
    [ProducesResponseType(typeof(IEnumerable<ComandaDto>), 200)]
    ...
    /// <summary>Adiciona um item Ã  comanda do cliente autenticado.</summary>
    ...
    /// <summary>Cancela uma comanda sem cobranÃ§a. Apenas Admin.</summary>
    ...
    /// Pode ser chamado pelo prÃ³prio cliente ou por qualquer Admin.
    /// </summary>
