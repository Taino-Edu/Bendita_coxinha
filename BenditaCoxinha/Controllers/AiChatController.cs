// =============================================================================
// AiChatController.cs â€” Assistente IA conversacional para o painel admin
//
// Endpoint: POST /api/ai/chat
// Acesso:   AdminOnly (JWT obrigatÃ³rio)
// =============================================================================
...
public class AiChatController : ControllerBase
{
    ...
    /// com base nos dados reais da loja (vendas, estoque, crediÃ¡rios, clientes).
    /// </summary>
    [HttpPost("chat")]
