// =============================================================================
// AnalyticsController.cs â€” Endpoints de analytics para o dashboard admin
// =============================================================================
...
{
    // Fuso horÃ¡rio de BrasÃ­lia â€” funciona em Linux (IANA) e Windows (ID legado).
    ...
    /// <summary>
    /// Converte uma data local de BrasÃ­lia no inÃ­cio UTC daquele dia.
    /// Ex.: 29/05 BR (UTC-3) â†’ 29/05 03:00:00 UTC
    /// </summary>
    ...
    public async Task<ActionResult<DashboardAnalyticsDto>> GetDashboard()
    {
        ...
        // â”€â”€ Comandas fechadas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Vendas avulsas (MongoDB) â€” 60 dias cobre todas as mÃ©tricas do dashboard â”€â”€
        ...
        // â”€â”€ Ticket mÃ©dio (Ãºltimos 30 dias â€” comandas + vendas avulsas) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Curva horÃ¡ria do dia â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Top produtos (Ãºltimos 30 dias â€” comandas + vendas avulsas) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Formas de pagamento (vendas avulsas + comandas hoje) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // Insights por cliente: gasto, ticket mÃ©dio, inatividade
    // -------------------------------------------------------------------------
    [HttpGet("clientes")]
    ...
    // Controle financeiro: receita, custo e margem no perÃ­odo filtrado
    // -------------------------------------------------------------------------
    [HttpGet("financeiro")]
        ...
        [FromQuery] string?   filterPaymentMethod = null)
    {
        ...
        // â”€â”€ Comandas base query â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Receita de comandas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        var receitaComandas = await comandasBaseQ
            .SumAsync(c => (decimal)c.TotalInCents) / 100m;

        // â”€â”€ Vendas avulsas (MongoDB) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Itens de comanda â€” com categoria e mÃ©todo de pagamento do pai â”€â”€â”€â”€â”€
        ...
        // â”€â”€ CrediÃ¡rios em aberto â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Breakdown dia a dia â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Breakdown por forma de pagamento â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Top produtos: comandas + PDV com breakdown por origem â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Pagamentos de crediÃ¡rio recebidos no perÃ­odo â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        {
            ClienteNome     = p.Crediario?.User?.Name ?? "â€”",
