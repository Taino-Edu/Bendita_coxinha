// =============================================================================
// ProductService.cs â€” ImplementaÃ§Ã£o de Produtos (estoque fÃ­sico)
// =============================================================================
...
public class ProductService : IProductService
{
    ...
    public async Task<Product> UpdateAsync(Product updated)
    {
        var existing = await _db.Products.FindAsync(updated.Id)
            ?? throw new KeyNotFoundException($"Produto {updated.Id} nÃ£o encontrado.");

        // AtualizaÃ§Ã£o campo a campo â€” evita sobrescrever com null/0 campos nÃ£o enviados pelo frontend.
    ...
    public async Task<bool> AdjustStockAsync(Guid id, int quantityDelta)
    {
        ...
        // UPDATE atÃ´mico â€” garante que estoque nunca fica negativo mesmo sob carga concorrente.
        // Retorna 0 rows se o produto nÃ£o existe, nÃ£o estÃ¡ ativo ou o delta resultaria em negativo.
